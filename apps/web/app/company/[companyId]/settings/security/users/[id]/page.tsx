...
export default function CompanyUserEditPage({
  ...
  // Load roles and employees for the selected scope
  useEffect(() => {
    async function loadRolesAndEmployees() {
      ...
      try {
        ...
        console.warn("Failed to load roles/employees", err);
      } finally {
  ...
  return (
    <AppLayout>
      <div className="space-y-4 py-4">
        ...
        ) : loading || !initialValues || optionsLoading || rolesLoading ? (
