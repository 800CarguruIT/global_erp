...
export default function CompanyDialerNewPage({ params }: Params) {
  ...
  return (
    <AppLayout>
      <div className="space-y-6 py-4">
        <h1 className="text-xl sm:text-2xl font-semibold">Create Company Dialer Integration</h1>
        ...
        {companyId ? (
          <DialerIntegrationForm scope="company" companyId={companyId} />
        ) : (
