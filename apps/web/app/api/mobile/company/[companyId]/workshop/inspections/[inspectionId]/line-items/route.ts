...
export async function POST(req: NextRequest, { params }: Params) {
  try {
    ...
    console.error(
      "POST /api/mobile/company/[companyId]/inspections/[inspectionId]/line-items error:",
      error,
    );
    return handleMobileError(error);
  }
...
export async function PATCH(req: NextRequest, { params }: Params) {
  try {
    ...
    const approvedNames = Array.isArray(body?.approvedNames)
      ? body.approvedNames
      : [];
    ...
    console.error(
      "PATCH /api/mobile/company/[companyId]/inspections/[inspectionId]/line-items error:",
      error,
    );
    return handleMobileError(error);
  }
