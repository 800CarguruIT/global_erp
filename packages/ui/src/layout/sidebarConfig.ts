...
export const SIDEBAR_CONFIG: Record<NavScope, Partial<Record<NavCategory, SidebarItem[]>>> = {
  ...
  company: {
    Main: [
      { labelKey: "global.nav.main", href: "/company/[companyId]", permissionKeys: ["company.dashboard.view"] },
      { labelKey: "global.nav.callCenter", href: "/company/[companyId]/call-center", permissionKeys: ["callcenter.view", "callcenter.dashboard.view", "callcenter.outbound.view", "callcenter.history.view", "callcenter.customers.view", "callcenter.datacenter.view", "callcenter.extensions.view", "callcenter.master_performance.view"] },
      { labelKey: "global.nav.leads", href: "/company/[companyId]/leads", permissionKeys: ["leads.view", "leads.create"] },
      ...
      { labelKey: "global.nav.marketing", href: "/company/[companyId]/marketing", permissionKeys: ["marketing.campaigns.view", "marketing.ads.view", "marketing.sms.view", "marketing.email.view", "marketing.templates.view", "marketing.social.view"] },
      { labelKey: "global.nav.hr", href: "/company/[companyId]/hr", permissionKeys: ["hr.employees.view", "company.users.view", "hr.branch_users.view", "hr.vendor_users.view"] },
      { label: "Roles & Permissions", href: "/company/[companyId]/settings/security/roles", permissionKeys: ["company.roles.manage"] },
      { label: "Users", href: "/company/[companyId]/settings/security/users", permissionKeys: ["company.users.view"] },
      ...
      { label: "Parts Quotes", href: "/company/[companyId]/parts-quotes", permissionKeys: ["quotes.parts.view"] },
      ...
      { label: "Workshop Earnings", href: "/company/[companyId]/workshop/earnings", permissionKeys: ["jobs.view", "workshop.earnings.view"] },
      { label: "Branches", href: "/company/[companyId]/branches", permissionKeys: ["branches.view", "branches.create"] },
      { label: "Vendors", href: "/company/[companyId]/vendors", permissionKeys: ["vendors.view", "vendors.create"] },
      { label: "Customers", href: "/company/[companyId]/customers", permissionKeys: ["crm.customers.view", "crm.customers.edit"] },
    ...
    Jobs: [
      ...
      { label: "Workshop", href: "/company/[companyId]/jobs/workshop", moduleKey: "jobs", permissionKeys: ["jobs.view", "jobs.workshop.view"] },
    ],
    Sales: [
      { label: "My Leads", href: "/company/[companyId]/sales/my-leads", moduleKey: "sales", permissionKeys: ["sales.view"] },
      { label: "Jobs", href: "/company/[companyId]/sales/jobs", moduleKey: "sales", permissionKeys: ["sales.view"] },
    ],
    Accounting: [
      { label: "Charts of Accounts", href: "/company/[companyId]/accounting/chart-of-accounts", permissionKeys: ["accounting.manage_chart"] },
      { label: "Accounts", href: "/company/[companyId]/accounting/accounts", permissionKeys: ["accounting.manage_chart", "accounting.view"] },
      { label: "Journals", href: "/company/[companyId]/accounting/journals", permissionKeys: ["accounting.post", "accounting.view"] },
...
export const SIDEBAR_TREE: Partial<Record<NavScope, SidebarItem[]>> = {
  ...
  company: [
    ...
    },
    {
      ...
      permissionKeys: ["workshop.earnings.view"],
      children: [
        { label: "Workshops", href: "/company/[companyId]/workshop/earnings", exactMatch: true, permissionKeys: ["workshop.earnings.view"] },
        { label: "Vendors", href: "/company/[companyId]/vendors", exactMatch: true, permissionKeys: ["workshop.earnings.view"] },
      ],
    },
    {
      label: "Sales Center",
    ...
    },
    {
      ...
      children: [
        ...
        {
          label: "RSA Assigned",
          href: "/company/[companyId]/leads/rsa/assigned",
          exactMatch: true,
          permissionKeys: ["leads.rsa.assigned.view", "leads.rsa.view", "leads.view"],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      permissionKeys: ["quotes.parts.view"],
      children: [
        { label: "Parts Quotes", href: "/company/[companyId]/parts-quotes", permissionKeys: ["quotes.parts.view"] },
      ],
    },
