...
export const SIDEBAR_CONFIG: Record<NavScope, Partial<Record<NavCategory, SidebarItem[]>>> = {
  ...
  company: {
    Main: [
      ...
      { label: "AI Inquiries", href: "/company/[companyId]/settings/ai/inquiries" },
      ...
      { label: "Recovery CC", href: "/company/[companyId]/recovery-cc" },
...
export const SIDEBAR_TREE: Partial<Record<NavScope, SidebarItem[]>> = {
  ...
  company: [
    ...
    { label: "Recovery CC", href: "/company/[companyId]/recovery-cc", permissionKeys: ["jobs.view"] },
