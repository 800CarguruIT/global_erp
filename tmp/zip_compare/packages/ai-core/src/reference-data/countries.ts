export type Country = {
  ...
  name: string;
  dialCode: string;
  defaultPlateFormat?: string;
  currency?: string;
  timezone?: string;
};

// Comprehensive ISO-3166 country list with calling codes
export const allCountries: Country[] = [
  ...
  { iso2: "PN", name: "Pitcairn Islands", dialCode: "+870" },
  ...
  { iso2: "AE", name: "United Arab Emirates", dialCode: "+971", defaultPlateFormat: "LL-####", currency: "AED", timezone: "Asia/Dubai" },
  { iso2: "GB", name: "United Kingdom", dialCode: "+44", defaultPlateFormat: "LL## LLL", currency: "GBP", timezone: "Europe/London" },
  { iso2: "US", name: "United States", dialCode: "+1", currency: "USD", timezone: "America/New_York" },
