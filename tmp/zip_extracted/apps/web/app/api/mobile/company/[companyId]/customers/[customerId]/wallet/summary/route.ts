...
export async function GET(req: NextRequest, { params }: Params) {
  try {
    ...
    const summary = await Crm.getCustomerWalletSummary(companyId, customerId);
    return createMobileSuccessResponse({ summary: summary ?? {} });
  } catch (error) {
    console.error(
      "GET /api/mobile/company/[companyId]/customers/[customerId]/wallet/summary error:",
      error
    );
