...
import { AppLayout, Card, AiInsightsPanel } from "@repo/ui";
...
function MarketingContent({ companyId }: { companyId: string | null }) {
  return (
    <div className="space-y-6 py-4">
      ...
      {companyId && (
        <AiInsightsPanel companyId={companyId} page="marketing" title="Marketing Intelligence" showKpis={true} showInsights={true} showSummary={false} compact={true} kpiColumns={2} maxInsights={3} />
      )}
